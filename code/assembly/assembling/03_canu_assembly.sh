...
OUTPUT="/home/matia/genome_analysis/analysis/genome_assembly/assembly_canu/03_canu_assembly"

# commands
canu -p canu_assembly -d $OUTPUT maxThreads=4 genomeSize=26.5m -pacbio-raw $INPUT
